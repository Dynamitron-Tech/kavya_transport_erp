...
export type VehicleType = 'truck' | 'trailer' | 'tanker' | 'container' | 'mini_truck' | 'pickup' | 'other';
...
export type JobStatus = 'draft' | 'pending_approval' | 'approved' | 'assigned' | 'in_progress' | 'completed' | 'cancelled';
export type JobPriority = 'low' | 'medium' | 'high' | 'urgent';
export type ContractType = 'per_trip' | 'per_ton' | 'per_km' | 'fixed' | 'monthly';

export type LRStatus = 'draft' | 'generated' | 'in_transit' | 'delivered' | 'pod_received' | 'pod_verified' | 'cancelled';
export type PaymentMode = 'to_pay' | 'paid' | 'to_be_billed' | 'fod';

export type EwayBillStatus = 'draft' | 'generated' | 'active' | 'in_transit' | 'extended' | 'completed' | 'cancelled' | 'expired';
...
export type TripStatus = 'planned' | 'started' | 'loading' | 'in_transit' | 'unloading' | 'completed' | 'cancelled';
export type ExpenseCategory = 'fuel' | 'toll' | 'driver_allowance' | 'loading' | 'unloading' | 'repair' | 'challan' | 'rto' | 'police' | 'other';

export type InvoiceStatus = 'draft' | 'sent' | 'paid' | 'partial' | 'overdue' | 'cancelled';
export type InvoiceType = 'client' | 'vendor' | 'credit_note' | 'debit_note';
