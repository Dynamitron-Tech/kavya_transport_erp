  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <KPICard title="Total Fleet" value={data?.total || 0} icon={<Truck size={18} className="text-gray-600" />} color="bg-gray-50" />
        <KPICard title="Available" value="—" icon={<CheckCircle2 size={18} className="text-green-600" />} color="bg-green-50" />
        <KPICard title="On Trip" value="—" icon={<Navigation size={18} className="text-blue-600" />} color="bg-blue-50" />
        <KPICard title="Maintenance" value="—" icon={<Wrench size={18} className="text-orange-600" />} color="bg-orange-50" />
      </div>

      <DataTable
        columns={columns}
        data={safeArray<Vehicle>(data)}
        total={data?.total || 0}
        page={filters.page}
