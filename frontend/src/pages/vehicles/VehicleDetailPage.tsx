  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-4">
        ...
        <button onClick={() => navigate('/vehicles/' + id + '/edit')} className="btn-secondary flex items-center gap-2"><Edit size={16} /> Edit</button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card">
          ...
          <div className="space-y-2">
            <button onClick={() => navigate('/trips/create?vehicle_id=' + id)} className="btn-primary w-full text-sm">Assign to Trip</button>
