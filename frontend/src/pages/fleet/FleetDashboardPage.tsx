      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {(activeTrips?.items as ActiveTripItem[] || []).slice(0, 5).map((trip: ActiveTripItem) => (
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {(recentAlerts?.items as FleetAlert[] || []).slice(0, 5).map((alert: FleetAlert) => (
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-2">
                <span className="text-xs font-medium text-red-600 bg-red-50 px-2 py-0.5 rounded-full">
                  {expiringDocs?.total_expired || 0} expired
                </span>
                <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full">
                  {expiringDocs?.total_expiring || 0} expiring
                </span>
              </div>
            </div>
            <div className="space-y-2">
              {(expiringDocs?.items as FleetExpiringDocument[] || []).slice(0, 4).map((doc: FleetExpiringDocument) => (
          ...
          <div className="card">
            ...
            <div className="space-y-2">
              {(upcomingMaintenance?.items as MaintenanceScheduleItem[] || []).slice(0, 4).map((item: MaintenanceScheduleItem) => (
