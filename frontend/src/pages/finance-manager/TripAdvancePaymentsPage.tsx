...
import { financeManagerService, type PendingAdvanceTripItem, type DriverAdvanceRequest } from '@/services/financeManagerService';
                ...
                <div key={trip.id} className="card flex flex-col gap-4">
                  ...
                  {trip.loaded_image_url && (
                    <div>
                      ...
                      <button
                        onClick={() => setViewImg(trip.loaded_image_url)}
