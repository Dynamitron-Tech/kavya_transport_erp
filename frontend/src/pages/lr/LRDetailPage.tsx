    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2 flex-shrink-0">
          ...
          {!lr.pod_received && <button onClick={handleUploadPOD} disabled={uploadPODMutation.isPending} className="btn-primary flex items-center gap-2 text-sm"><Upload size={14} /> {uploadPODMutation.isPending ? 'Uploading...' : 'Upload POD'}</button>}
          {lr.pod_received && !lr.pod_verified && <button onClick={() => verifyPODMutation.mutate()} disabled={verifyPODMutation.isPending} className="btn-success flex items-center gap-2 text-sm"><CheckCircle size={14} /> Verify POD</button>}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="card">
          ...
          <div className="space-y-2 text-sm">
            ...
            {lr.consignor_gst && <p className="text-gray-400">GST: {lr.consignor_gst}</p>}
          </div>
        </div>
        <div className="card">
          ...
          <div className="space-y-2 text-sm">
            ...
            {lr.consignee_gst && <p className="text-gray-400">GST: {lr.consignee_gst}</p>}
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col items-center py-4">
            {lr.pod_verified ? (
              <>
                ...
                <p className="font-semibold text-green-700">POD Verified</p>
              ...
              <>
                ...
                <p className="font-semibold text-amber-700">POD Received</p>
