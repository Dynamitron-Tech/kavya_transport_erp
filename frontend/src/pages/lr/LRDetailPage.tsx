    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2 flex-shrink-0">
          <button className="btn-secondary flex items-center gap-2 text-sm"><Printer size={14} /> Print</button>
          {!lr.pod_received && <button className="btn-primary flex items-center gap-2 text-sm"><Upload size={14} /> Upload POD</button>}
          {lr.pod_received && !lr.pod_verified && <button className="btn-success flex items-center gap-2 text-sm"><CheckCircle size={14} /> Verify POD</button>}
        </div>
      </div>
