    ...
    },
    {
      ...
      render: (lr) => (
        <div>
          ...
          {lr.consignor_gst && <p className="text-xs text-gray-400">GST: {lr.consignor_gst}</p>}
        </div>
      ),
    },
    {
      ...
      render: (lr) => (
        <div>
          ...
          {lr.consignee_gst && <p className="text-xs text-gray-400">GST: {lr.consignee_gst}</p>}
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (lr) => (
        <div className="flex items-center gap-1">
          {lr.pod_verified ? (
            <span className="badge-success flex items-center gap-1"><CheckCircle size={12} /> Verified</span>
          ) : lr.pod_received ? (
            <span className="badge-warning">Received</span>
          ) : (
