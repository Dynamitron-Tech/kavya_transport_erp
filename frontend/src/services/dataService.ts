...
export const fleetService = {
  ...
  exportReport: async (reportType: string, format = 'pdf', params?: any) => {
    const data = await api.get('/fleet/reports/export', { params: { report_type: reportType, format, ...params } });
    return data;
  },
};
...
export const accountantService = {
  ...
  exportReport: async (reportType: string, format = 'pdf', params?: any) => {
    const data = await api.get('/accountant/reports/export', { params: { report_type: reportType, format, ...params } });
    return data;
  },
};
