...
- generic [ref=e3]:
  ...
  - generic [ref=e513]:
    - banner [ref=e514]:
      - generic [ref=e515]:
        - navigation [ref=e517]:
          ...
          - generic [ref=e526]:
            - img [ref=e527]
            - button "Reports" [ref=e529] [cursor=pointer]
          - generic [ref=e530]:
            - img [ref=e531]
        ...
        - generic [ref=e534]:
          - generic [ref=e535]:
            - img [ref=e536]
            - textbox "Search jobs, LR, trips..." [active] [ref=e539]: Reports E2E 644655
    ...
    - main [ref=e608]:
      - generic [ref=e610]:
        - generic [ref=e612]:
          - heading "Reports & Analytics" [level=1] [ref=e613]
          - paragraph [ref=e614]: Generate detailed reports and insights
          - paragraph [ref=e615]: "Jobs: 2 | Trips: 2 | LR: 34"
        - generic [ref=e616]:
          - button "Trip Summary Overview of all trips with completion rates, distances, and timelines" [ref=e617] [cursor=pointer]:
            - img [ref=e619]
            - heading "Trip Summary" [level=3] [ref=e622]
            - paragraph [ref=e623]: Overview of all trips with completion rates, distances, and timelines
          - button "Vehicle Performance Vehicle utilization, mileage analysis, and operational efficiency" [ref=e624] [cursor=pointer]:
            - img [ref=e626]
            - heading "Vehicle Performance" [level=3] [ref=e631]
            - paragraph [ref=e632]: Vehicle utilization, mileage analysis, and operational efficiency
          - button "Driver Performance Driver ratings, trip counts, fuel efficiency, and safety metrics" [ref=e633] [cursor=pointer]:
            - img [ref=e635]
            - heading "Driver Performance" [level=3] [ref=e640]
            - paragraph [ref=e641]: Driver ratings, trip counts, fuel efficiency, and safety metrics
          - button "Fuel Analysis Fuel consumption trends, cost per km, and efficiency comparisons" [ref=e642] [cursor=pointer]:
            - img [ref=e644]
            - heading "Fuel Analysis" [level=3] [ref=e647]
            - paragraph [ref=e648]: Fuel consumption trends, cost per km, and efficiency comparisons
          - button "Revenue Analysis Revenue trends by client, route, and vehicle type" [ref=e649] [cursor=pointer]:
            - img [ref=e651]
            - heading "Revenue Analysis" [level=3] [ref=e653]
            - paragraph [ref=e654]: Revenue trends by client, route, and vehicle type
          - button "Expense Analysis Detailed expense breakdown by category, vehicle, and trip" [ref=e655] [cursor=pointer]:
            - img [ref=e657]
            - heading "Expense Analysis" [level=3] [ref=e660]
            - paragraph [ref=e661]: Detailed expense breakdown by category, vehicle, and trip
          - button "Route Analysis Route profitability, frequency, and optimization insights" [ref=e662] [cursor=pointer]:
            - img [ref=e664]
            - heading "Route Analysis" [level=3] [ref=e667]
            - paragraph [ref=e668]: Route profitability, frequency, and optimization insights
          - button "Client Outstanding Outstanding receivables by client with aging analysis" [ref=e669] [cursor=pointer]:
            - img [ref=e671]
            - heading "Client Outstanding" [level=3] [ref=e675]
            - paragraph [ref=e676]: Outstanding receivables by client with aging analysis
          - button "Maintenance Report Vehicle maintenance history, costs, and upcoming schedules" [ref=e677] [cursor=pointer]:
            - img [ref=e679]
            - heading "Maintenance Report" [level=3] [ref=e681]
            - paragraph [ref=e682]: Vehicle maintenance history, costs, and upcoming schedules
```