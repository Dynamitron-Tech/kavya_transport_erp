...
test.describe('Vehicle Compliance', () => {
  test.beforeEach(async ({ page }) => {
    await gotoAndReady(page, '/fleet/vehicle-compliance');
  });

  test('page heading is visible after load', async ({ page }) => {
    await expectHeading(page, /vehicle compliance|compliance/i);
  });
