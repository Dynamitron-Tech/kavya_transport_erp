...
test.describe('Driver Compliance', () => {
  test.beforeEach(async ({ page }) => {
    await gotoAndReady(page, '/fleet/driver-compliance');
  });

  test('page heading is visible after load', async ({ page }) => {
    await expectHeading(page, /driver compliance|compliance/i);
  });
