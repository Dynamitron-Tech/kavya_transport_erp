...
test.describe('Route Calculator', () => {
  test.beforeEach(async ({ page }) => {
    await gotoAndReady(page, '/trips/route-calculator');
  });

  test('page heading is visible after load', async ({ page }) => {
    await expectHeading(page, /route calculator|route/i);
  });
  ...
  test('primary create action works end to end', async ({ page }) => {
    await runPrimaryCreateFlow(page, {
      openButton: /calculate|new|create/i,
      prefix: 'Route Calculator E2E',
    });
