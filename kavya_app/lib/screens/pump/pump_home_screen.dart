    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(
            icon: Icon(Icons.edit_note_outlined, color: Color(0xFF8494A4)),
            selectedIcon: Icon(Icons.edit_note, color: Color(0xFFEA580C)),
            label: 'Log',
          ),
          NavigationDestination(
            icon: Icon(Icons.history_outlined, color: Color(0xFF8494A4)),
            selectedIcon: Icon(Icons.history, color: Color(0xFFEA580C)),
            label: 'History',
          ),
          NavigationDestination(
            icon: Icon(Icons.local_shipping_outlined, color: Color(0xFF8494A4)),
            selectedIcon: Icon(Icons.local_shipping, color: Color(0xFFEA580C)),
            label: 'Vehicles',
          ),
        ],
      ),
